...
class FormPassword extends StatefulWidget {
  ...
  const FormPassword({Key? key ,required this.restaurante}) : super(key: key);
        ...
        children: <Widget>[
          ...
          TextFormField(
            ...
            validator: (value) {
              ...
              else if (contrasennaController.text != widget.restaurante.contrasenna) {
            ...
            child: MaterialButton(
              onPressed: () async {
                ...
                if (_formKey.currentState!.validate()) {
                  ...
                  int valor = await Restaurante.actualizarContrasena(contrasenna1, widget.restaurante.idUsuario);
                  if (valor == 1) {
