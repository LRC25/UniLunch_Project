...
class FormPassword extends StatefulWidget {
  ...
  const FormPassword({Key? key ,required this.cliente}) : super(key: key);
        ...
        children: <Widget>[
          ...
          TextFormField(
            ...
            validator: (value) {
              ...
              else if (contrasennaController.text != widget.cliente.contrasenna) {
            ...
            child: MaterialButton(
              onPressed: () async {
                ...
                if (_formKey.currentState!.validate()) {
                  ...
                  int valor = await Cliente.actualizarContrasena(contrasenna1, widget.cliente.idUsuario);
                  if (valor == 1) {
